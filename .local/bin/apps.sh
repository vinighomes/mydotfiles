...
if [[ "$layout" == 'NO' ]]; then
	...
	option_4=" Nitrogen <span weight='light' size='small'><i>($web_cmd)</i></span>"
	option_5=" Gimp <span weight='light' size='small'><i>($music_cmd)</i></span>"
	option_6=" Calculator <span weight='light' size='small'><i>($setting_cmd)</i></span>"
else
	option_1=""
	option_2=""
	option_3=""
